...
echo "Starting Julia"
# run training script
julia --project=$path_to_codes/TMLR_GOKU-UI/Experiments --optimize=3 --threads=1 $path_to_codes/TMLR_GOKU-UI/Experiments/scripts/Training/Baselines/LatentODE/train_latent_ode_cluster.jl "$SLURM_TMPDIR/$dataset"