...
#SBATCH --time=7-00:00:00     # in d-hh:mm:ss
#SBATCH --ntasks=20
...
echo "Starting Julia"
# run training script
julia --project=$path_to_codes/TMLR_GOKU-UI/Experiments --optimize=3 --threads=1 $path_to_codes/TMLR_GOKU-UI/Experiments/scripts/Training/train_goku_cluster.jl "$SLURM_TMPDIR/$dataset"